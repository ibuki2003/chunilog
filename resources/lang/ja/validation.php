...
return [
    ...
    */
    ...
    'between'              => [
        'numeric' => ':attributeは:min以上:max未満で指定してください。',
        'file'    => ':attributeは:min kB以上:max kB未満で指定してください。',
        'string'  => ':attributeは:min文字以上:max文字未満で指定してください。',
        'array'   => ':attributeは:min個以上:max個未満で指定してください。',
    ],
